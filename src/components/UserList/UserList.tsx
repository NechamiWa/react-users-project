    ...
    <div className="container-fluid">
      <div className='row'>
        <div className="col-md-6  mt6">
          ...
          {userAdded ? <p>User added successfully</p> : ''}
          {isModalDisplay ? <MyModal title="Delete User" funcOnConfirm={deleteUser} funcOnClose={closeModal}><h5>Are you sure you want to delete?</h5></MyModal> : ''}
        </div>
        <br></br>
